...
from app.model.model import embeddings_model, model
...
def preparation_node(state, output_file_name = "repo_structured_nested.json"): 
    ...
    return {"retriever": retriever, "vector_db": vector_db, "chunked_documents": chunked_documents, "qa_agent": qa_agent}